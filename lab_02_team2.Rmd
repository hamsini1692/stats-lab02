...
ggplot(movie_sample_exploration, aes(x=budget/1000000, y=revenue/1000000, color=vote_count)) +
  geom_point() +
  xlab("Budget") +
  ylab("Revenue") +
...
ggplot(movie_sample_filtered, aes(x = budget, y = revenue, color = month(release_date, label = TRUE))) +
  geom_point() +
...
ggplot(movie_filtered_df, aes(x=budget, y=revenue,  color=vote_count)) +
  geom_point() +
  xlab("Budget") +
  ylab("Revenue") +
  ggtitle("Budget vs Revenue Scatter Plot")
